...
const PORTFOLIO_HERO_STORIES = [
  { name: "Agnikul Cosmos", logo: "assets/portfolio-logos/062-agnikul.png", url: "https://agnikul.in/#/", image: "assets/img/home-1.jpg", scale: 1.4,
  ...
  { name: "Unbox Robotics", logo: "assets/portfolio-logos/064-unboxrobotics.png", url: "https://unboxrobotics.com/", image: "assets/img/home-2.jpg", scale: 0.75,
  ...
  { name: "Kaleidofin", logo: "assets/portfolio-logos/068-kaleidofin.png", url: "https://kaleidofin.com/", image: "assets/img/home-3.jpg", scale: 1.328,
  ...
  { name: "Bellatrix Aerospace", logo: "assets/portfolio-logos/030-bellatrix-aerospace.png", url: "https://bellatrix.aero/", image: "assets/img/home-4.jpg", scale: 0.75,
  ...
  { name: "Riskcovry", logo: "assets/portfolio-logos/070-riskcovry.png", url: "https://riskcovry.com/", image: "assets/img/home-1.jpg", scale: 1.363,
  ...
  { name: "CogniTensor", logo: "assets/portfolio-logos/096-cognitensor.png", url: "https://www.cognitensor.com/", image: "assets/img/home-3.jpg", scale: 1.4,
    text: "An AI company turning industrial and supply-chain data into predictive decisions.",
    meta: ["Deep Tech", "AI", "Mumbai"] },
  { name: "GUVI", logo: "assets/portfolio-logos/087-guvi.png", url: "https://www.guvi.in/", image: "assets/img/home-4.jpg", scale: 0.75,
  ...
  { name: "JAI Kisan", logo: "assets/portfolio-logos/072-jai-kisan.png", url: "https://www.jai-kisan.com/", image: "assets/img/home-1.jpg", scale: 1.178,
    text: "A rural fintech platform delivering embedded credit and financial services for India’s farmers and agri-businesses.",
    meta: ["Digitalization", "Fintech", "Mumbai"] },
  { name: "Tan90 Thermal Solutions", logo: "assets/portfolio-logos/058-tan90thermal.png", url: "https://www.tan90thermal.com/", image: "assets/img/home-2.jpg", scale: 0.75,
  ...
  { name: "Kosha.ai", logo: "assets/portfolio-logos/131-kosha.png", url: "https://www.kosha.ai/", image: "assets/img/home-3.jpg", scale: 0.979,
